...
def unet():
    ...
    #多尺度池化
    pool4_1 = MaxPooling2D(pool_size=(1, 1),data_format='channels_last')(conv4)
    print ('pool4_1:',pool4_1.shape)
    pool4_2 = MaxPooling2D(pool_size=(2, 2),data_format='channels_last')(conv4)
    print ('pool4_2:',pool4_1.shape)
    pool4_3 = MaxPooling2D(pool_size=(4, 4),data_format='channels_last')(conv4)
    print ('pool4_3:',pool4_1.shape)
    pool4_4 = MaxPooling2D(pool_size=(8, 8),data_format='channels_last')(conv4)
    print ('pool4_2:',pool4_1.shape)
    
    conv5_1 = Conv2D(128, (3, 3), activation="relu", padding="same")(pool4_1)
    print ('conv5_1:',conv5_1.shape)
    conv5_2 = Conv2D(128, (3, 3), activation="relu", padding="same")(pool4_2)
    print ('conv5_2:',conv5_2.shape)
    conv5_3 = Conv2D(128, (3, 3), activation="relu", padding="same")(pool4_3)
    print ('conv5_3:',conv5_3.shape)
    conv5_4 = Conv2D(128, (3, 3), activation="relu", padding="same")(pool4_4)
    print ('conv5_4:',conv5_4.shape)
    
    Up4_2=UpSampling2D(size=(2, 2),data_format='channels_last')(conv5_2)
    print ('Up4_2:',Up4_2.shape)
    Up4_3=UpSampling2D(size=(4, 4),data_format='channels_last')(conv5_3)
    print ('Up4_3:',Up4_2.shape)
    Up4_4=UpSampling2D(size=(8, 8),data_format='channels_last')(conv5_4)
    print ('Up4_4:',Up4_2.shape)
    Concatenate=concatenate([conv5_1,Up4_2,Up4_3,Up4_4])
    print ('Concatenate:',Concatenate.shape)

    
    conv6 = Conv2D(512, (3, 3), activation="relu", padding="same")(Concatenate)         
